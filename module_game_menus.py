...
#
#  2) Game-menu flags (int).  See header_game_menus.py for a list of available
#  flags.
#     You can also specify menu text color here, with the menu_text_color macro
#  3) Game-menu text (string).
#  4) mesh-name (string).  Not currently used.  Must be the string "none"
#  5) Operations block (list).  A list of operations.  See header_operations.py
#  for reference.
#     The operations block is executed when the game menu is activated.
#  6) List of Menu options (List).
#     Each menu-option record is a tuple containing the following fields:
#   6.1) Menu-option-id (string) used for referencing game-menus in other
#   files.
#        The prefix mno_ is automatically added before each menu-option.
#   6.2) Conditions block (list).  This must be a valid operation block.  See
#   header_operations.py for reference.
#        The conditions are executed for each menu option to decide whether the
#        option will be shown to the player or not.
#   6.3) Menu-option text (string).
#   6.4) Consequences block (list).  This must be a valid operation block.  See
#   header_operations.py for reference.
#        The consequences are executed for the menu option that has been
#        selected by the player.
#
#
# Note: The first Menu is the initial character creation menu.
####################################################################################################################
game_menus = [("start_game_0",menu_text_color(0xFF000000) | mnf_disable_all_keys,
...
##      (assign, "$g_custom_battle_scenario", "$g_custom_battle_scenario"),
####      #Default banners
####      (troop_set_slot, "trp_banner_background_color_array", 126,
####      0xFF212221),
####      (troop_set_slot, "trp_banner_background_color_array", 127,
####      0xFF212221),
####      (troop_set_slot, "trp_banner_background_color_array", 128,
####      0xFF2E3B10),
####      (troop_set_slot, "trp_banner_background_color_array", 129,
####      0xFF425D7B),
####      (troop_set_slot, "trp_banner_background_color_array", 130,
####      0xFF394608),
##      ],
##    [
####      ("custom_battle_scenario_1",[], "Skirmish 1",
...
##      ]),
##
##      ("tutorial_2",[(eq,1,0),],"Tutorial #2: Fighting with a shield.
##      {s2}",[
...
##
##      ("tutorial_3",[(eq,1,0),],"Tutorial #3: Fighting without a shield.
##      {s3}",[
...
##           (troop_raise_proficiency_linear, "$g_player_troop",
##           wpt_one_handed_weapon, 70),
##           (troop_raise_proficiency_linear, "$g_player_troop",
##           wpt_two_handed_weapon, 70),
##           (troop_raise_proficiency_linear, "$g_player_troop", wpt_polearm,
##           70),
##           (troop_raise_proficiency_linear, "$g_player_troop", wpt_crossbow,
##           70),
##           (troop_raise_proficiency_linear, "$g_player_troop", wpt_throwing,
##           70),
##
...
##     (troop_raise_proficiency_linear, "trp_player", wpt_one_handed_weapon,
##     -10000),
##     (troop_raise_proficiency_linear, "trp_player", wpt_two_handed_weapon,
##     -10000),
...
##       (troop_raise_proficiency_linear, "$g_player_troop",
##       wpt_one_handed_weapon, 100),
##       (troop_raise_proficiency_linear, "$g_player_troop",
##       wpt_two_handed_weapon, 30),
...
##  ),
  ...
  ("start_character_1",mnf_disable_all_keys,
    ...
    (str_clear,s14),
    (str_clear,s15),],
    [("start_noble",[],"An impoverished noble.",[(assign,"$background_type",cb_noble),
 ...
 they afforded you a good education and trained you from childhood for the rigors of aristocracy and life at court."),
    ...
    ("start_merchant",[],"A travelling merchant.",[(assign,"$background_type",cb_merchant),
      (assign, reg3, "$character_gender"),
 ...
 living mostly for the moments when you could sell something to somebody."),
	(jump_to_menu,"mnu_start_character_2"),]),
    ("start_guard",[],"A veteran warrior.",[(assign,"$background_type",cb_guard),
      (assign, reg3, "$character_gender"),
 ...
 education. You learned mainly how to defend yourself on the streets, with or without a weapon in hand."),
	(jump_to_menu,"mnu_start_character_2"),]),
    ("start_forester",[],"A hunter.",[(assign,"$background_type",cb_forester),
      (assign, reg3, "$character_gender"),
 ...
 though your brothers and sisters might not be so fortunate."),
	(jump_to_menu,"mnu_start_character_2"),]),
    ("start_nomad",[],"A steppe nomad.",[(assign,"$background_type",cb_nomad),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@{reg3?daughter:son}"),
 ...
 how to ride almost before you learned how to walk. "),
	(jump_to_menu,"mnu_start_character_2"),]),
    ("start_thief",[],"A thief.",[(assign,"$background_type",cb_thief),
      (assign, reg3, "$character_gender"),
...
##      (assign, reg3, "$character_gender"),
##      (str_store_string,s10,"@A {reg3?daughter:son} that nobody wanted, you
##      were left to the church as a baby,\
## a foundling raised by the priests and nuns to their own traditions.\
## You were only one of many other foundlings and orphans, but you nonetheless
## received a lot of attention\
## as well as many years of study in the church library and before the altar.
## They taught you many things.\
## Gradually, faith became such a part of your life that it was no different
## from the blood coursing through your veins."),
##	(jump_to_menu,"mnu_start_character_2"),
##    ]),
    ("go_back",[],"Go back",
     [(jump_to_menu,"mnu_start_game_1"),]),]),
  ("start_character_2",0,
    ...
    "none",
    [],
    [("page",[],"A page at a nobleman's court.",[(assign,"$background_answer_2", cb2_page),
      (assign, reg3, "$character_gender"),
 ...
 and competition. You also learned from the rough games of the other children, who battered at each other with sticks in imitation of their elders' swords."),
	(jump_to_menu,"mnu_start_character_3"),]),
      ("apprentice",[],"A craftsman's apprentice.",[(assign,"$background_answer_2", cb2_apprentice),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 ...
 you wished to stay."),
	(jump_to_menu,"mnu_start_character_3"),]),
      ("stockboy",[],"A shop assistant.",[(assign,"$background_answer_2",cb2_merchants_helper),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 ...
 got the better deal."),
	(jump_to_menu,"mnu_start_character_3"),]),
      ("urchin",[],"A street urchin.",[(assign,"$background_answer_2",cb2_urchin),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 ...
 always one step ahead of the law and those who wished you ill."),
	(jump_to_menu,"mnu_start_character_3"),]),
      ("nomad",[],"A steppe child.",[(assign,"$background_answer_2",cb2_steppe_child),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
...
## you attached yourself to a troupe of wandering entertainers, going from town
## to town setting up mummer's\
## shows.  It was a life of hard work, selling, begging and stealing your
## living from the punters who flocked\
## to watch your antics.  Over time you became a performer well capable of
## attracting a crowd."),
##	(jump_to_menu,"mnu_start_character_3"),
##    ]),
##      ("courtier",[],"Courtier.",[
...
##      (str_store_string,s12,"@{reg3?girl:boy}"),
##      (str_store_string,s11,"@As a {s12} growing out of childhood,\
## you spent much of your life at court, inserting yourself into the
## tightly-knit circles of nobility.\
## With the years you became more and more involved with the politics and
## intrigue demanded of a high-born {s13}.\
## You could not afford to remain a stranger to backstabbing and political
## violence, even if you wanted to."),
##	(jump_to_menu,"mnu_start_character_3"),
##    ]),
...
##      (str_store_string,s11,"@As a {s12} growing out of childhood,\
## you were trained and educated to perform the duties and wield the rights of
## a noble landowner.\
## The managing of taxes and rents were equally important in your education as
## diplomacy and even\
## personal defence.  You learned everything you needed to become a lord of
## your own hall."),
##      (else_try),
##      (str_store_string,s11,"@As a {s12} growing out of childhood,\
## you were trained and educated to the duties of a noble {s13}.  You learned
## much about the household arts,\
## but even more about diplomacy and decorum, and all the things that a future
## husband might choose to speak of.\
## Truly, you became every inch as shrewd as any lord, though it would be rude
## to admit it aloud."),
##      (try_end),
##	(jump_to_menu,"mnu_start_character_3"),
##    ]),
...
##      (str_store_string,s12,"@{reg3?girl:boy}"),
##      (str_store_string,s11,"@As a {s12} growing out of childhood,\
## you became an acolyte in the church, the lowest rank on the way to
## priesthood.\
## Years of rigorous learning and hard work followed.  You were one of several
## acolytes,\
## performing most of the menial labour in the church in addition to being
## trained for more holy tasks.\
## On the night of your adulthood you were allowed to conduct your first
## service.\
## After that you were no longer an acolyte {s12}, but a {s13} waiting to take
## your vows into the service of God."),
##	(jump_to_menu,"mnu_start_character_3"),
##    ]),
      ("go_back",[],"Go back.",
     [(jump_to_menu,"mnu_start_character_1"),]),]),
...
## somewhere along the way you had become a {s13}, and the whole world seemed
## to change around you.\
## You left your old life behind to travel the roads as a mercenary, a bravo,
## guarding caravans for coppers\
## or bashing in heads for silvers.  You became a {s14} of the open road,
## working with bandits as often as against.\
## Going from fight to fight, you grew experienced at battle, and you learned
## what it was to kill."),
...
## somewhere along the way you had become a {s13}, and the whole world seemed
## to change around you.\
## You signed on with a mercenary company and travelled far from your home.
## The life you found was rough and\
## ready, marching to the beat of strange drums and learning unusual ways of
## fighting.\
## There were men who taught you how to wield any weapon you desired, and
## plenty of battles to hone your skills.\
## You were one of the charmed few who survived through every campaign in which
## you marched."),
##	(jump_to_menu,"mnu_start_character_4"),
##        ]),

      ("squire",[(eq,"$character_gender",tf_male)],"A squire.",[(assign,"$background_answer_3",cb3_squire),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 ...
 of men who used guile as well as valor to achieve their aims."),
	(jump_to_menu,"mnu_start_character_4"),]),
      ("lady",[(eq,"$character_gender",tf_female)],"A lady-in-waiting.",[(assign,"$background_answer_3",cb3_lady_in_waiting),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 ...
 with a little bit of subtlety."),
	(jump_to_menu,"mnu_start_character_4"),]),
      ("troubadour",[],"A troubadour.",[(assign,"$background_answer_3",cb3_troubadour),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
 ...
 drunken crowds in your taverns, and even better at talking anyone out of anything you wanted."),
	(jump_to_menu,"mnu_start_character_4"),]),
      ("student",[],"A university student.",[(assign,"$background_answer_3",cb3_student),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {reg3?woman:man}, and the whole world seemed to change around you.\
 ...
 or how an angry townsman can be persuaded to set down his club and accept cash compensation for the destruction of his shop."),
	(jump_to_menu,"mnu_start_character_4"),]),
      ("peddler",[],"A goods peddler.",[(assign,"$background_answer_3",cb3_peddler),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
 ...
 giving you a good price. Soon, you knew, you would be well-placed to start your own trading empire..."),
	(jump_to_menu,"mnu_start_character_4"),]),
      ("craftsman",[],"A smith.",[(assign,"$background_answer_3", cb3_craftsman),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
 ...
 With food in your belly and logs on your fire, you could take pride in your work and your growing reputation."),
	(jump_to_menu,"mnu_start_character_4"),]),
      ("poacher",[],"A game poacher.",[(assign,"$background_answer_3", cb3_poacher),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
...
## somewhere along the way you had become a {s13}, and the whole world seemed
## to change around you.\
## You packed your few belongings and went out into the world to spread the
## word of God.  You preached to\
## anyone who would listen, and impressed many with the passion of your
## sermons.  Though you had taken a vow\
## to remain in poverty through your itinerant years, you never lacked for
## food, drink or shelter; the\
## hospitality of the peasantry was always generous to a rising {s13} of
## God."),
##	(jump_to_menu,"mnu_start_character_4"),
##        ]),
      ("go_back",[],"Go back.",
  ...
  ("start_character_4",mnf_disable_all_keys,
    ...
    #Finally, what made you decide to strike out on your own as an
    #adventurer?",
    "none",
    [],
    [("revenge",[],"Personal revenge.",[(assign,"$background_answer_4", cb4_revenge),
 ...
 and these debts can only be paid in blood..."),
      ...
      ("death",[],"The loss of a loved one.",[(assign,"$background_answer_4",cb4_loss),
      (str_store_string,s13,"@Only you know exactly what caused you to give up your old life and become an adventurer.\
 ...
 or honour the name that you can no longer bear to speak..."),
        (jump_to_menu,"mnu_choose_skill"),]),
      ("wanderlust",[],"Wanderlust.",[(assign,"$background_answer_4",cb4_wanderlust),
      (str_store_string,s13,"@Only you know exactly what caused you to give up your old life and become an adventurer.\
...
##      (str_store_string,s13,"@Only you know exactly what caused you to give
##      up your old life and become an adventurer.\
## Regardless, the intense faith burning in your soul would not let you find
## peace in any single place.\
## There were others in the world, souls to be washed in the light of God.  Now
## you preach wherever you go,\
## seeking to bring salvation and revelation to the masses, be they faithful or
## pagan.  They will all know the\
## glory of God by the time you're done..."),
##        (jump_to_menu,"mnu_choose_skill"),
##        ]),
      ("disown",[],"Being forced out of your home.",[(assign,"$background_answer_4",cb4_disown),
      (str_store_string,s13,"@Only you know exactly what caused you to give up your old life and become an adventurer.\
 ...
 now, and you must face the fact that you're out in the wide wide world. Alone to sink or swim..."),
        (jump_to_menu,"mnu_choose_skill"),]),
     ("greed",[],"Lust for money and power.",[(assign,"$background_answer_4",cb4_greed),
      (str_store_string,s13,"@Only you know exactly what caused you to give up your old life and become an adventurer.\
...
##        (str_store_string, s14, "@You are particularly talented at
##        swordsmanship."),
...
##        (jump_to_menu,"mnu_past_life_explanation"),
##        ]),
      ("begin_adventuring",[],"Become an adventurer and ride to your destiny.",[(set_show_messages, 0),
           (try_begin),
...
#             (start_presentation, "prsnt_custom_banner"),
  ...
  ("past_life_explanation",mnf_disable_all_keys,
    ...
    [(try_begin),
     ...
     (try_end),],
    [("view_next",[],"{s5}",[(val_add,"$current_string_reg",1),
        (jump_to_menu, "mnu_past_life_explanation"),]),
      ("continue",[],"Continue...",
       []),
      ("go_back_dot",[],"Go back.",[(jump_to_menu, "mnu_choose_skill"),]),]),
  ...
  ("faction_orders",0,
   ...
   [(str_clear, s9),
    ...
    (try_for_range, ":faction_no", kingdoms_begin, kingdoms_end),
	   ...
	   #  (faction_set_slot, ":faction_no", slot_faction_ai_last_rest_time,
	   #  ":hours"),
	   #(try_end),
      (try_begin),      
  ...
  ("character_report",0,
   ...
   [(try_begin),
	...
	("continue",[(eq,"$cheat_mode",1),
		(str_store_troop_name, s14, "$g_talk_troop"),],"{!}CHEAT! - increase your relation with {s14}",
   ...
   [],
    [("camp_recruit_prisoners",
       [(troops_can_join, 1),
        ...
        (try_end),], "Recruit some of your prisoners to your party.",
      ...
      ("action_rename_kingdom",
       [(eq, "$players_kingdom_name_set", 1),
         ...
         (faction_slot_eq, "fac_player_supporters_faction", slot_faction_leader, "trp_player"),],"Rename your kingdom.",
  ...
  ("camp_action_read_book",0,
   ...
   [],
    [("action_read_book_1",[(player_has_item, "itm_book_tactics"),
                             ...
                             (str_store_item_name, s1, "itm_book_tactics"),],"{s1}.",
      ...
      ("action_read_book_2",[(player_has_item, "itm_book_persuasion"),
                             ...
                             (str_store_item_name, s1, "itm_book_persuasion"),],"{s1}.",
      ...
      ("action_read_book_3",[(player_has_item, "itm_book_leadership"),
                             ...
                             (str_store_item_name, s1, "itm_book_leadership"),],"{s1}.",
      ...
      ("action_read_book_4",[(player_has_item, "itm_book_intelligence"),
                             ...
                             (str_store_item_name, s1, "itm_book_intelligence"),],"{s1}.",
      ...
      ("action_read_book_5",[(player_has_item, "itm_book_trade"),
                             ...
                             (str_store_item_name, s1, "itm_book_trade"),],"{s1}.",
      ...
      ("action_read_book_6",[(player_has_item, "itm_book_weapon_mastery"),
                             ...
                             (str_store_item_name, s1, "itm_book_weapon_mastery"),],"{s1}.",
      ...
      ("action_read_book_7",[(player_has_item, "itm_book_engineering"),
                             ...
                             (str_store_item_name, s1, "itm_book_engineering"),],"{s1}.",
...
#          (try_end),
    ...
    [("encounter_attack",
      ...
      ("encounter_leave",[(eq,"$cant_leave_encounter", 0),],"Leave.",[###NPC companion changes begin
              (try_begin),
                  (eq, "$encountered_party_friendly", 0),
                  (encountered_party_is_attacker),
...
#					(store_relation, ":relation_with_stack_troop", ":victorious_faction",
#					"fac_player_faction"),
...
#Troop commentary changes end
      ...
      ("encounter_retreat",[(eq,"$cant_leave_encounter", 1),
         ...
         (ge, ":player_count", ":enemy_party_strength"),],"Pull back, leaving some soldiers behind to cover your retreat.",[(jump_to_menu, "mnu_encounter_retreat_confirm"),]),
         
      ("encounter_surrender",[(eq,"$cant_leave_encounter", 1),],"Surrender.",[(assign,"$g_player_surrenders",1)]),]),
...
#NPC companion changes end
  ...
  ("total_victory", 0,
    ...
    [# We exploit the menu condition system below.
        # The conditions should make sure that always another screen or menu is
        # called.
        (assign, ":break", 0),
        (try_begin),
        ...
        (try_begin),
          ...
          (gt, "$g_ally_party", 0),          
          #(store_add, ":total_str_without_player",
        ...
        (else_try),
          ...
          (try_for_range, ":stack_no", "$last_defeated_hero", ":num_stacks"), #May 31 bug note -- this now returns some heroes in victorious party as well
            ...
            #steve post 0912 changes begin - removed, this is duplicated
            #elsewhere in game menus
            #(call_script, "script_add_log_entry",
            #logent_lord_defeated_by_player, "trp_player", -1, ":stack_troop",
            #":defeated_faction"),
            (try_begin),
        ...
        (else_try),                 
          ...
          #(call_script, "script_party_prisoners_add_party_companions",
          #"p_temp_party", "p_collective_enemy"),
        
          #p_total_enemy_casualties deki yarali askerler p_temp_party'e
          #prisoner olarak eklenecek.
          ...
          (try_begin),
            ...
            # move ally_party_initial_strength/(player_party_initial_strength +
            # ally_party_initial_strength) prisoners to ally party.
            # First we collect the share of prisoners of the ally party and
            # distribute those among the allies.
            (store_sub, ":ally_party_initial_strength", ":total_initial_strength", ":player_party_initial_strength"),

            #(call_script, "script_party_calculate_strength",
            #"p_ally_party_backup"),
            #(assign,":ally_party_initial_strength", reg(0)),
            #(store_add, ":total_initial_strength",
            #":player_party_initial_strength", ":ally_party_initial_strength"),
            ...
            #TODO: This doesn't handle prisoners if our allies joined battle
            #after us.
            (try_begin),
              (gt, "$g_ally_party", 0),
              (distribute_party_among_party_group, "p_temp_party_2", "$g_ally_party"),
            (try_end),
            #next if there's anything left, we'll open up the party exchange
            #screen and offer them to the player.
          (try_end),
...
#          (try_begin),
#            (gt, "$g_ally_party", 0),
#            (call_script, "script_party_add_party", "$g_ally_party",
#            "p_temp_party"), #Add remaining prisoners to ally TODO: FIX it.
#          (else_try),
#            (party_get_num_attached_parties, ":num_quick_attachments",
#            "p_main_party"),
#            (gt, ":num_quick_attachments", 0),
#            (party_get_attached_party_with_rank, ":helper_party",
#            "p_main_party", 0),
#            (call_script, "script_party_add_party", ":helper_party",
#            "p_temp_party"), #Add remaining prisoners to our reinforcements
#          (try_end),
...
##            (str_store_string, s0, "@After the battle you are aghast to find
##            that one of the terrible blows you suffered has left a deep,
##            disfiguring scar on your face, horrifying those around you.  Your
...
##            (eq, ":random_attribute", ca_intelligence),
  ...
  ("pre_join",0,
    ...
    [("pre_join_help_attackers",[(store_faction_of_party, ":attacker_faction", "$g_encountered_party_2"),
          ...
          "Move in to help the {s2}.",[(select_enemy,0),
              (assign,"$g_enemy_party","$g_encountered_party"),
              (assign,"$g_ally_party","$g_encountered_party_2"),
              (jump_to_menu,"mnu_join_battle")]),
      ("pre_join_help_defenders",[(store_faction_of_party, ":attacker_faction", "$g_encountered_party_2"),
          (store_relation, ":attacker_relation", ":attacker_faction", "fac_player_supporters_faction"),
          (store_faction_of_party, ":defender_faction", "$g_encountered_party"),
          (store_relation, ":defender_relation", ":defender_faction", "fac_player_supporters_faction"),
          (ge, ":defender_relation", 0),
          (lt, ":attacker_relation", 0),],
          "Rush to the aid of the {s1}.",[(select_enemy,1),
  ...
  ("join_order_attack",mnf_disable_all_keys,
    ...
    [(call_script, "script_party_calculate_strength", "p_main_party", 1), #skip player
      ...
      #(party_collect_attachments_to_party, "$g_ally_party",
      #"p_collective_ally"),
...
#      ("zendar_leave",[],"Leave
#      town.",[[leave_encounter],[change_screen_return]]),
  ...
  ("battlefields",0,
    ...
    [("enter_f1",[],"{!}Field 1",[[set_jump_mission,"mt_ai_training"],[jump_to_scene,"scn_field_1"],[change_screen_mission]]),
      ...
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),]),
  ("dhorak_keep",0,
#    "Dhorak Keep, the stronghold of the bandits stands overlooking the barren
#    wilderness.",
...
##    "{s1} has been besieged by {s2}, and the enemy seems to be preparing for
##    an assault!\
## What will you do?",
##    "none",
##    [
...
##           ]),
##      ("do_not_defend_against_siege",[],"Find a secure place and wait
##      there.",
##       [
##           (change_screen_return),
##           ]),
...
##  ),
  ...
  ("join_siege_outside",mnf_scale_picture,
    ...
    [("approach_besiegers",[(store_faction_of_party, ":faction_no", "$g_encountered_party_2"),
                             ...
                             (store_relation, ":relation", ":faction_no", "fac_player_supporters_faction"),
                             (lt, ":relation", 0),],"Approach the siege camp.",[(jump_to_menu, "mnu_besiegers_camp_with_allies"),]),
      ("pass_through_siege",[(store_faction_of_party, ":faction_no", "$g_encountered_party"),
                             (store_relation, ":relation", ":faction_no", "fac_player_supporters_faction"),
                             (ge, ":relation", 0),],"Pass through the siege lines and enter {s1}.",
...
##          (jump_to_menu, "mnu_total_victory"),
        ...
        (else_try),
          ...
          (eq, "$g_battle_result", -1),
          (eq, ":ally_num_soldiers", 0), #battle lost (TODO : also compare this with routed allies too like in other
                                         #parts)
          (leave_encounter),
          (change_screen_return),
        (try_end),],
    [("talk_to_siege_commander",[],"Request a meeting with the commander.",[(call_script, "script_get_meeting_scene"), (assign, ":meeting_scene", reg0),
...
#          (party_set_slot, "$g_encountered_party", slot_town_lord,
#          stl_unassigned),
...
#            (party_get_num_companions, ":no_companions",
#            "$g_encountered_party"),
#            (ge, ":no_companions", 1),
...
##                                                   (change_screen_map_conversation, ":cur_guard")
      ...
      ("castle_cheat_interior",[(eq, "$cheat_mode", 1)], "{!}CHEAT! Interior.",[(set_jump_mission,"mt_ai_training"),
                                                       ...
                                                       (change_screen_mission)]),
      ("castle_cheat_exterior",[(eq, "$cheat_mode", 1)], "{!}CHEAT! Exterior.",[#                                                       (set_jump_mission,"mt_town_default"),
                                                       (set_jump_mission,"mt_ai_training"),
    ...
    [("request_shelter",[(party_slot_eq, "$g_encountered_party",slot_party_type, spt_castle),
       ...
       [(party_get_slot, ":castle_lord", "$g_encountered_party", slot_town_lord),
        ...
        (else_try),
          ...
          #(troop_get_slot, ":castle_lord_relation", ":castle_lord",
          #slot_troop_player_relation),
          (try_begin),
   ...
   ("castle_besiege",mnf_scale_picture,
    ...
    [(troop_get_type, ":is_female", "trp_player"),
        ...
        (else_try),
          ...
          (jump_to_menu, "mnu_total_defeat"),
        (try_end),],
    [("siege_request_meeting",[(eq, "$cant_talk_to_enemy", 0)],"Call for a meeting with the castle commander.", [(assign, "$cant_talk_to_enemy", 1),
      ...
      ("wait_24_hours",[],"Wait until tomorrow.", [(assign,"$auto_besiege_town","$g_encountered_party"),
...
##           (set_battle_advantage, reg0),
 ...
 {reg4} hours.",
    ...
    [("build_siege_tower_cont",[],
       "Start building.", [(assign, "$g_siege_method", 2),
           (store_current_hours, ":cur_hours"),
           (call_script, "script_get_max_skill_of_player_party", "skl_engineer"),
   ...
   ("castle_attack_walls_simulate",mnf_scale_picture | mnf_disable_all_keys,
    ...
    [(try_begin),
        ...
        (try_end),],
    [##      ("lead_next_wave",[(eq, "$no_soldiers_left", 0)],"Lead the next wave of
##      attack personally.", [
##           (party_get_slot, ":battle_scene", "$g_encountered_party",
##           slot_castle_exterior),
##           (set_party_battle_mode),
...
##           (change_screen_mission),
##       ]),
##      ("continue_attacking",[(eq, "$no_soldiers_left", 0)],"Order your
##      soldiers to keep attacking...", [
##                                    (jump_to_menu,"mnu_castle_attack_walls_3"),
##                                    ]),
##      ("call_soldiers_back",[(eq, "$no_soldiers_left", 0)],"Call your
##      soldiers back.",[(jump_to_menu,"mnu_castle_outside")]),
...
##        (display_message, "@{!}player_str={reg0} friend_str={reg1}
##        enemy_str={reg2}"),
...
{reg1? You may station troops here to defend it against enemies who may try to recapture it. Also, you should select now whether you will hold the {reg2?town:castle} yourself or give it to a faithful vassal...:}",# Only visible when castle is taken without being a vassal of a kingdom.
    ...
    [(party_clear, "$g_encountered_party"),
        ...
        #(call_script, "script_add_log_entry",
        #logent_castle_captured_by_player, "trp_player",
        #"$g_encountered_party", -1, "$g_encountered_party_faction"),
 ...
 It is time to send word to {s9} about your victory. {s5}",
    ...
    [("castle_taken_claim",[(eq, "$player_has_homage", 1)],
		...
		("castle_taken_claim_2",[(troop_get_slot, ":spouse", "trp_player", slot_troop_spouse),
...
("requested_castle_granted_to_another_female",mnf_scale_picture,
 ...
 However, if you return them of your own free will, he may let the betrayal go without a fight.",
    ...
    [("leave_faction_give_back", [], "Renounce your oath and give up your holdings.",
       [#Troop commentary changes begin
#        (call_script, "script_add_log_entry", logent_renounced_allegiance,
#        "trp_player", -1, "$g_talk_troop", "$g_talk_troop_faction"),
#Troop commentary changes end
        (call_script, "script_player_leave_faction", 1), #1 means give back fiefs
        (change_screen_return),]),
      ("leave_faction_hold", [(str_store_party_name, s2, "$g_center_to_give_to_player"),], "Renounce your oath and rule your lands, including {s2}, in your own name.",
...
###    "The rest of the castle garrison recognizes that their situation is
###    hopeless and surrenders.  {s1} is at your mercy now.  What do you want
###    to do with this castle?",
##    "_",
##    "none",
##    [
##        (jump_to_menu, "mnu_town"),
...
##    "You will need to assign one of your companions as the castellan.  Who
##    will it be?",
##    "none",
##    [
...
##          (troop_slot_eq, ":companion", slot_troop_occupation,
##          slto_player_companion),
##          (troop_set_slot, "trp_temp_troop", ":num_captains", ":companion"),
##        (try_end),
##    ],
##    [
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      0),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         0),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      1),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         1),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      2),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         2),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      3),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         3),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      4),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         4),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      5),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         5),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      6),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         6),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      7),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         7),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      8),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         8),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      9),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         9),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      10),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         10),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      11),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         11),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      12),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         12),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      13),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         13),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      14),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         14),(jump_to_menu,"mnu_castle_captain_chosen")]),
##      ("castellan_candidate", [(troop_get_slot, ":captain", "trp_temp_troop",
##      15),(gt,":captain",0),(str_store_troop_name, s5,":captain")],
##         "{s5}", [(troop_get_slot, "$selected_castellan", "trp_temp_troop",
##         15),(jump_to_menu,"mnu_castle_captain_chosen")]),
##
##      ("cancel",[],
##         "Cancel...",
##         [(jump_to_menu, "mnu_town")]),
...
##        (party_set_slot, "$g_encountered_party", slot_town_lord,
##        "trp_player"),
##        (party_set_faction, "$g_encountered_party",
##        "fac_player_supporters_faction"),
##        (try_for_range, ":slot_no", 0, 20), #clear temp troop slots just in
##        case
##          (troop_set_slot, "trp_temp_troop", ":slot_no", 0),
##        (try_end),
##        (jump_to_menu, "mnu_town"),
...
##        (call_script, "script_encounter_calculate_fit"),
##        (try_begin),
##          (call_script, "script_party_count_fit_regulars",
##          "p_collective_enemy"),
...
##
##            (try_for_range, ":troop_no", kingdom_heroes_begin,
##            kingdom_heroes_end),
##              (troop_slot_eq, ":troop_no", slot_troop_occupation,
##              slto_kingdom_hero),
##              (troop_slot_eq, ":troop_no", slot_troop_is_prisoner, 0),
##              (troop_get_slot, ":party_no", ":troop_no",
##              slot_troop_leaded_party),
##              (gt, ":party_no", 0),
##              (party_slot_eq, ":party_no", slot_party_ai_state,
##              spai_besieging_center),
##              (party_slot_eq, ":party_no", slot_party_ai_object,
##              "$g_encountered_party"),
##              (party_slot_eq, ":party_no", slot_party_ai_substate, 1),
##              (call_script, "script_party_set_ai_state", ":party_no",
##              spai_undefined, -1),
##              (call_script, "script_party_set_ai_state", ":party_no",
##              spai_besieging_center, ":center_no"),
##            (try_end),
##            (display_message, "@{!}TODO: Enemy retreated.  The assault has
##            ended, siege continues."),
##            (change_screen_return),
##          (try_end),
####          (assign, "$g_center_under_siege_battle", 0),
##        (try_end),
...
##  ),
  ...
  ##            (lt, ":min_enemy_str", "$g_friend_fit_for_battle"),
    ...
    [("siege_defender_join_battle",
       [(neg | troop_is_wounded, "trp_player"),],
          "Join the battle.",[(party_set_next_battle_simulation_time, "$g_encountered_party", -1),
              (assign, "$g_battle_result", 0),
              (try_begin),
                (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                (party_get_slot, ":battle_scene", "$g_encountered_party", slot_town_walls),
      ...
      ("siege_defender_troops_join_battle",[(call_script, "script_party_count_members_with_full_health", "p_main_party"),
                                            ...
                                            (ge, reg0, 3)],
          "Order your men to join the battle without you.",[(party_set_next_battle_simulation_time, "$g_encountered_party", -1),
              (select_enemy,1),
              (assign,"$g_enemy_party","$g_encountered_party_2"),
              (assign,"$g_ally_party","$g_encountered_party"),
  ...
  ("village",mnf_enable_hot_keys,
    ...
    [("village_manage",
      ...
      ("village_center",[(neg | party_slot_eq, "$current_town", slot_village_state, svs_looted),
       ...
       [(try_begin),
         ...
         (else_try),
           ...
           (change_screen_mission),
         (try_end),],"Door to the village center."),
      ("village_buy_food",[(party_slot_eq, "$current_town", slot_village_state, 0),
                           (neg | party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),],"Buy supplies from the peasants.",
       [(try_begin),
           (call_script, "script_cf_enter_center_location_bandit_check"),
         (else_try),
      ...
      ("collect_taxes_qst",[(party_slot_eq, "$current_town", slot_village_state, 0),
                            ...
                            (quest_get_slot, reg5, "qst_collect_taxes", slot_quest_current_state),], "{reg5?Continue collecting taxes:Collect taxes} due to {s1}.",
      ...
      ("train_peasants_against_bandits_qst",
       [(party_slot_eq, "$current_town", slot_village_state, 0),
         ...
         (quest_slot_eq, "qst_train_peasants_against_bandits", slot_quest_target_center, "$current_town"),], "Train the peasants.",
       [(jump_to_menu, "mnu_train_peasants_against_bandits"),]),

      ("village_hostile_action",[(party_slot_eq, "$current_town", slot_village_state, 0),
                                 (neg | party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
								 (neq, "$players_kingdom", "$g_encountered_party_faction"),], "Take a hostile action.",
  ...
  ("village_hostile_action",0,
    ...
    "none",
    [],
    [("village_take_food",[(party_slot_eq, "$current_town", slot_village_state, 0),
          (neg | party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
          (party_get_slot, ":merchant_troop", "$current_town", slot_town_elder),
          ...
          (try_end),
          (eq, ":town_stores_not_empty", 1),],"Force the peasants to give you supplies.",
...
#           (party_add_template, "$current_town", "pt_villagers_in_raid"),
  ...
  ("recruit_volunteers",0,
    ...
    [("continue_not_enough_gold",
      ...
      ("continue",
      [(eq, reg7, 0),
        (eq, reg5, 0),], #noone willing to join
      "Continue...",
 ...
 currently building {s7}. The building will be completed after {reg8} day{reg9?s:}.:}",
    ...
    [("castle_station_troops",
      ...
      ("make_stuff",[(party_slot_eq, "$g_encountered_party",slot_center_has_workshop, 1),],"Make_Stuff",[(jump_to_menu, "mnu_stuff_selection")],),
       ...
       "Build a workshop.",[(assign, "$g_improvement_type", slot_center_has_workshop),
  ...
  ("armor_menu",0,
    ...
    [("order_armor_cont",[(store_troop_gold, ":cur_gold", "trp_player"),
     ...
     ("armor_poor_fuck",[(store_troop_gold, ":cur_gold", "trp_player"),
                                 (lt, ":cur_gold", 500)],
...
#Troop commentary changes end
 ...
 It looks like you'll have a fight on your hands if you continue.",
    ...
    [(set_background_mesh, "mesh_pic_villageriot"),
       ...
       (try_end),],
    [("village_raid_attack",[],"Charge them.",[(store_random_in_range, ":enmity", -10, -5),
          (call_script, "script_change_player_relation_with_center", "$current_town", ":enmity"),
          (try_begin),
            (party_get_slot, ":town_lord", "$current_town", slot_town_lord),
            (gt, ":town_lord", 0),
...
#NPC companion changes end
    ...
    [("continue",[], "Continue...",
       [(jump_to_menu, "mnu_close"),
		  ...
		  #below line changed with below lines to make plunder result more realistic.
		  #Now only items produced in bound town can be stolen after raid.
	 ...
	 #          (val_add, ":prosperity", 5),
        ...
        (try_begin),
		  ...
		  (else_try),
            ...
            (str_store_string,s11,"@ You see the banner of {s7} over the castle gate."),
          (else_try),
##            (str_store_string,s11,"@ This castle seems to belong to no
##            one."),
        ...
        (else_try),
          ...
          (else_try),
            ...
            (str_store_string,s11,"@ You see the banner of {s7} over the town gates."),
          (else_try),
##            (str_store_string,s11,"@ The townsfolk here have declared their
##            independence."),
...
#		(try_end),
    ...
    [("castle_castle",
      [(party_slot_eq,"$current_town",slot_party_type, spt_castle),        
        ...
        (try_end),],"Go to the Lord's hall{s1}.",
       [(try_begin),
      ...
      ("town_castle",[(party_slot_eq,"$current_town",slot_party_type, spt_town),        
      ...
      "Take a walk around the streets.",
       [#If the player is fighting his or her way out
         ...
         (else_try),
           ...
           (jump_to_scene, ":town_scene"),
           (change_screen_mission),
         (try_end),],"Door to the town center."),
      
      ("town_tavern",[(party_slot_eq,"$current_town",slot_party_type, spt_town),
          (this_or_next | eq,"$entry_to_town_forbidden",0),
          (eq, "$sneaked_into_town",1),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
      ...
      [(party_slot_eq,"$current_town",slot_party_type, spt_castle),],
       ...
       [(try_begin),
         ...
         (else_try),                   
           ...
           (jump_to_scene, ":cur_castle_exterior"),
           (change_screen_mission),
         (try_end),], "To the castle courtyard."),
     ...
     ("town_enterprise",
      ...
      [(store_sub, ":town_order", "$current_town", towns_begin),
        ...
        (change_screen_mission),],"Door to your enterprise."), 
...
#			-1),
	...
	(gt, "$love_interest_in_town", 0),],
	  "Attempt to visit a lady",
       [(jump_to_menu, "mnu_lady_visit"),], "Door to the garden."),										
...
##          ]),
      ...
      ("town_leave",[],"Leave...",
      [(assign, "$g_permitted_to_center",0),
        (change_screen_return,0),],"Leave Area."),
  ...
  ("lady_visit",0,
    ...
    "none",
    [],
    [("visit_lady_1", [(gt, "$love_interest_in_town", 0),
...
# They must learn field discipline and the steadiness to follow orders in
# combat before they can be thought to use arms.",
 ...
 but they offer you all they can find to show their gratitude.",
  ...
  ("town_trade_assessment_begin",0, 
   #"You overhear the following details about the roads out of town
   #:^(experimental feature -- this may go into dialogs)^{s42}^You also
   #overhear several discussions about the price of trade goods across the
   #local area.^You listen closely, trying to work out the best deals around.",
 ...
 You must flee back through the gates before all the guards in the town come down on you!",
    ...
    [("sneak_caught_fight",[],"Try to fight your way out!",
       [(assign,"$all_doors_locked",1),
           ...
           #(store_faction_of_party, ":town_faction","$current_town"),
           #(faction_get_slot, ":tier_2_troop", ":town_faction",
           #slot_faction_tier_2_troop),
           #(faction_get_slot, ":tier_3_troop", ":town_faction",
...
#####################################################################
 ...
 You get up and try to look for any other survivors from your party.",
  ...
  ("captivity_wilderness_taken_prisoner",mnf_scale_picture,
    ...
    [("continue",[],"Continue...",
       [# Explanation of removing below code : heros are already being removed
	     # with 50% (was 75%, I decreased it) probability in mnu_total_defeat, why
	     # here there is additionally 30% removing of heros?
		 # See codes linked to "mnu_captivity_start_wilderness_surrender" and
		 # "mnu_captivity_start_wilderness_defeat" which is connected with here they
		 # all also enter
		 # "mnu_total_defeat" and inside the "mnu_total_defeat" there is
		 # script_party_remove_all_companions which removes 50% (was 75%, I decreased
		 # it) of compainons from player party.
         ...
         #  (troop_set_slot, ":npc", slot_troop_playerparty_history,
         #  pp_history_scattered),
         #  (assign, "$last_lost_companion", ":npc"),
         #  (store_faction_of_party, ":victorious_faction",
         #  "$g_encountered_party"),
         #  (troop_set_slot, ":npc", slot_troop_playerparty_history_string,
         #  ":victorious_faction"),
         ...
         #    (ge, ":reln", 0),
         #    (store_distance_to_party_from_party, ":dist", ":town_no",
         #    "p_main_party"),
 ...
 You shall have to find him and give him your oath in person. {s5}",
  ...
  ("notification_player_faction_active",0,
    ...
    [(set_fixed_point_multiplier, 100),
	  ...
	  (try_end),],
    [("appoint_spouse",[(troop_slot_ge, "trp_player", slot_troop_spouse, 1),
	  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
	  (neg | troop_slot_eq, ":player_spouse", slot_troop_occupation, slto_kingdom_hero),
	  (str_store_troop_name, s10, ":player_spouse"),],"Appoint your wife, {s10}...",
       [(troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
	   (assign, "$g_player_minister", ":player_spouse"),
	   (jump_to_menu, "mnu_minister_confirm"),]),

      ("appoint_npc1",[(main_party_has_troop, "trp_npc1"),
	  (str_store_troop_name, s10, "trp_npc1"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc1"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc2",[(main_party_has_troop, "trp_npc2"),
	  (str_store_troop_name, s10, "trp_npc2"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc2"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc3",[(main_party_has_troop, "trp_npc3"),
	  (str_store_troop_name, s10, "trp_npc3"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc3"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc4",[(main_party_has_troop, "trp_npc4"),
	  (str_store_troop_name, s10, "trp_npc4"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc4"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc5",[(main_party_has_troop, "trp_npc5"),
	  (str_store_troop_name, s10, "trp_npc5"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc5"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc6",[(main_party_has_troop, "trp_npc6"),
	  (str_store_troop_name, s10, "trp_npc6"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc6"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc7",[(main_party_has_troop, "trp_npc7"),
	  (str_store_troop_name, s10, "trp_npc7"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc7"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc8",[(main_party_has_troop, "trp_npc8"),
	  (str_store_troop_name, s10, "trp_npc8"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc8"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc9",[(main_party_has_troop, "trp_npc9"),
	  (str_store_troop_name, s10, "trp_npc9"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc9"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc10",[#was npc9
	  (main_party_has_troop, "trp_npc10"),
	  (str_store_troop_name, s10, "trp_npc10"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc10"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc11",[(main_party_has_troop, "trp_npc11"),
	  (str_store_troop_name, s10, "trp_npc11"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc11"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc12",[(main_party_has_troop, "trp_npc12"),
	  (str_store_troop_name, s10, "trp_npc12"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc12"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc13",[(main_party_has_troop, "trp_npc13"),
	  (str_store_troop_name, s10, "trp_npc13"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc13"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc14",[(main_party_has_troop, "trp_npc14"),
	  (str_store_troop_name, s10, "trp_npc14"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc14"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc15",[(main_party_has_troop, "trp_npc15"),
	  (str_store_troop_name, s10, "trp_npc15"),],"Appoint {s10}",
       [(assign, "$g_player_minister", "trp_npc15"),
	   (jump_to_menu, "mnu_minister_confirm"),]),
	   
      ("appoint_npc16",[(main_party_has_troop, "trp_npc16"),
	  (str_store_troop_name, s10, "trp_npc16"),],"Appoint {s10}",
...
#      (else_try),
  ...
  ("notification_lady_requests_visit",0, #add this once around seven days after the last visit, or three weeks, or
                                         #three months
  ...
  (#pre lady visit
    ...
    [("enter",
	[(call_script, "script_get_kingdom_lady_social_determinants", "$love_interest_in_town"),
	(troop_slot_eq, reg0, slot_lord_granted_courtship_permission, 1)], "Enter",
	[(jump_to_menu, "mnu_town"),
	(call_script, "script_setup_meet_lady", "$love_interest_in_town", "$g_encountered_party"),]),
     
	("nurse",
	[(eq, "$nurse_assists_entry", 1),], "Go with the nurse",
	[(jump_to_menu, "mnu_town"),
	(call_script, "script_setup_meet_lady", "$love_interest_in_town", "$g_encountered_party"),]),

	
	("nurse",
	[(eq, "$nurse_assists_entry", 2),], "Wait by the spring",
	[(jump_to_menu, "mnu_town"),
	(call_script, "script_setup_meet_lady", "$love_interest_in_town", "$g_encountered_party"),]),
...
#          (try_end),
  ...
  ("establish_court",mnf_disable_all_keys,
    ...
    [("establish",[(player_has_item, "itm_tools"),
	  (player_has_item, "itm_velvet"),],"Establish {s4} as your court",
